...
if __name__ == '__main__':
    ...
    try:
        ...
        if sys.argv[1] in ['test01', 'gdsjkl01']:
            val1 = IsacValue(isac_node, 'test://isac_cmd/this/is/a/test', 12,
                             metadata={'is_read_only': False, 'genre': 'test'})
        # else:
        #     val1 = IsacValue(isac_node, 'this.is.a.test')

        if sys.argv[1] in ['test02', 'fdsfds02']:
            val2 = IsacValue(isac_node, 'test://isac_cmd/this/is/another/test',
                             42, metadata={'is_read_only': True, 'genre': 'real'})
        # else:
