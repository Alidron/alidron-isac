...
def test_survey_value_static_tags(two_nodes):
    ...
    iv_nostatictags = IsacValue(nA, uri_nostatictags, survey_last_value=False, survey_static_tags=False)
...
def test_survey_values_metadata(two_nodes):
    ...
    iv_meta1 = IsacValue(nA, uri_meta1, metadata={'a': 1, 'b': 2}, survey_last_value=False, survey_static_tags=False)
    uri_meta2 = 'test://test_survey_value/test_survey_value_metadata/iv_meta2'
    iv_meta2 = IsacValue(nA, uri_meta2, metadata={'c': 3, 'd': 4}, survey_last_value=False, survey_static_tags=False)
    ...
    assert nB.survey_values_metadata('test://test_survey_value/test_survey_value_metadata/unknown', timeout=0.1) == {}
...
def test_survey_value_history(two_nodes):
    ...
    assert nB.survey_value_history('test://test_survey_value/test_survey_value_history/unknown', (0, 1000), timeout=0.1) is None
